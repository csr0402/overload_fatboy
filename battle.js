window.initBattleEngine = function (bossType, onEndCallback) {
  ...
  if (bossType === 'both') {
    bossImg.src = 'images/xihu_super_angry.png';
    bossImg2.src = 'images/qianzhen_super_angry.png';
  } else {
    bossImg.src = bossType === 'xihu' ? 'images/xihu_super_angry.png' : 'images/qianzhen_super_angry.png';
  }
