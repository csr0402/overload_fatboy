window.dialogueData = [
  {
    "id": "start",
    "speaker": "旁白",
    "text": "你是一位熱愛探索的{player}，站在台灣中部與南部的交通十字路口上，正苦惱接下來該前往何處旅行...",
    "xiSprite": "idle",
    "qianSprite": "idle"
  },
  {
  ...
  },
  {
    "id": "intro_qian",
    "speaker": "前鎮醬 (小前)",
    "text": "切，大老遠出門旅行，當然要來我們前鎮區啊！高聳的高雄總圖、夢幻的高雄之眼摩天輪，還有最先進的輕軌捷運，這才是頂級享受！🏙️",
    "xiSprite": "dim",
  ...
  },
  {
    "id": "intro_duel",
    "speaker": "旁白",
    "text": "兩位性格與風格截然不同的雙城少女，希望你做出抉擇。對決正式開始！接下來將有 20 題的考驗，包含「喜好大抉擇」與突如其來的「知識隨堂考」，準備好了嗎？",
    "xiSprite": "idle",
    "qianSprite": "idle"
  },

  {
    "id": "q1_pref_xi",
    "speaker": "溪湖醬 (小溪)",
    "text": "第一題！美食對決！我們溪湖有頂級羊肉爐與多汁的巨峰葡萄，絕對滿足你的味蕾！🍇🍲",
    "xiSprite": "active-talk",
    "qianSprite": "dim"
  },
  {
    "id": "q1_pref_qian",
    "speaker": "前鎮醬 (小前)",
    "text": "哼，我們前鎮擁有全台最大的前鎮漁港，現撈的生猛海鮮與高空景觀餐廳才是極致饗宴！🦀🥂",
    "xiSprite": "dim",
    "qianSprite": "active-talk"
  },
  {
    "id": "q1_pref_choice",
    "speaker": "決策時間",
    "text": "Q1 (抉擇): 你的胃更嚮往哪一邊？",
    "xiSprite": "idle",
    "qianSprite": "idle",
    "choices": [
      { "text": "🍲 溪湖羊肉爐與田園農產", "points": { "xihu": 10, "qianzhen": -5 }, "next": "q1_xi_quiz" },
      { "text": "🦀 前鎮生猛海鮮與精緻料理", "points": { "xihu": -5, "qianzhen": 10 }, "next": "q1_xi_quiz" }
    ]
  },

  {
    "id": "q1_xi_quiz",
    "speaker": "溪湖醬 (小溪)",
    "text": "嘿嘿，順便考考你！溪湖鎮最著名的水果特產，被譽為「黑紫色的寶石」是哪一種？",
    "xiSprite": "active-talk",
    "qianSprite": "dim",
    "choices": [
...

  {
    "id": "q2_pref_xi",
    "speaker": "溪湖醬 (小溪)",
    "text": "交通方面，來搭乘浪漫的復古『五分車』，聽著汽笛聲穿梭在綠油油的田野與韭菜花海中吧！🚂",
    "xiSprite": "active-talk",
    "qianSprite": "dim"
  },
  {
    "id": "q2_pref_qian",
    "speaker": "前鎮醬 (小前)",
    "text": "現代輕軌捷運冷氣超涼，平穩滑行在綠色草皮軌道上，還能欣賞亞洲新灣區的科幻美景！🚈",
    "xiSprite": "dim",
    "qianSprite": "active-talk"
  },
  {
    "id": "q2_pref_choice",
    "speaker": "決策時間",
    "text": "Q3 (抉擇): 你渴望哪種移動方式？",
    "xiSprite": "idle",
    "qianSprite": "idle",
    "choices": [
      { "text": "🚂 搭乘復古五分車漫遊田野", "points": { "xihu": 10, "qianzhen": -5 }, "next": "q1_qian_quiz" },
...

  {
    "id": "q3_pref_xi",
    "speaker": "溪湖醬 (小溪)",
    "text": "想買東西？當然要去傳統市場跟老街啊！感受最真實的人情味與熱情的叫賣聲！🛍️",
    "xiSprite": "active-talk",
    "qianSprite": "dim"
  },
  {
  ...
  },
  {
    ...
    "qianSprite": "idle",
    "choices": [
      { "text": "🛍️ 充滿人情味的傳統市場", "points": { "xihu": 10, "qianzhen": -5 }, "next": "q2_xi_quiz" },
...

  {
    ...
    "choices": [
      ...
      { "text": "🎢 頂樓雲霄飛車", "points": { "xihu": 0, "qianzhen": -10 }, "next": "q5_pref_xi" },
...

  {
    "id": "q3_xi_quiz",
    "speaker": "溪湖醬 (小溪)",
    "text": "溪湖鎮在彰化縣的地理位置非常特別，你知道它被稱為什麼嗎？",
    "xiSprite": "active-talk",
    "qianSprite": "dim",
    "choices": [
      { "text": "🌊 濱海的最西端", "points": { "xihu": -10, "qianzhen": 0 }, "next": "q6_pref_xi" },
      { "text": "⛰️ 最高的八卦山脈", "points": { "xihu": -10, "qianzhen": 0 }, "next": "q6_pref_xi" },
...

  {
    "id": "q6_pref_xi",
    "speaker": "溪湖醬 (小溪)",
    "text": "這裡有百年的糖廠文化，古老的煙囪與斑駁的磚牆，每一處都寫滿了台灣早期的甜蜜歷史！🕰️",
    "xiSprite": "active-talk",
    "qianSprite": "dim"
  },
  {
  ...
  },
  {
    "id": "q6_pref_choice",
    "speaker": "決策時間",
    "text": "Q11 (抉擇): 你對哪種歷史脈絡更有興趣？",
    "xiSprite": "idle",
    "qianSprite": "idle",
    "choices": [
      { "text": "🕰️ 充滿懷舊氣息的糖業歷史", "points": { "xihu": 10, "qianzhen": -5 }, "next": "q3_qian_quiz" },
...

  {
    ...
    "qianSprite": "active-talk",
    "choices": [
      { "text": "🚋 高雄環狀輕軌 (LRT)", "points": { "xihu": 0, "qianzhen": 5 }, "next": "q7_pref_xi" },
      { "text": "🚇 傳統地下捷運", "points": { "xihu": 0, "qianzhen": -10 }, "next": "q7_pref_xi" },
...

  {
    "id": "q7_pref_xi",
    "speaker": "溪湖醬 (小溪)",
    "text": "站在彰化平原中心，看著一望無際的綠色稻浪與藍天白雲，這種開闊感是最療癒的！☁️",
    "xiSprite": "active-talk",
    "qianSprite": "dim"
  },
  {
  ...
  },
  {
    "id": "q7_pref_choice",
    "speaker": "決策時間",
    "text": "Q13 (抉擇): 哪一種風景最能打動你？",
    "xiSprite": "idle",
    "qianSprite": "idle",
    "choices": [
      { "text": "☁️ 一望無際的平原與自然田野", "points": { "xihu": 10, "qianzhen": -5 }, "next": "q4_xi_quiz" },
...

  {
    ...
    "choices": [
      ...
      { "text": "🥘 薑母鴨", "points": { "xihu": -10, "qianzhen": 0 }, "next": "q8_pref_xi" },
      { "text": "🍜 牛肉麵", "points": { "xihu": -10, "qianzhen": 0 }, "next": "q8_pref_xi" }
    ]
  },
  ...
  },
  {
    "id": "q8_pref_qian",
    "speaker": "前鎮醬 (小前)",
    "text": "在百貨公司挑選包裝精緻的法式甜點或精品特產，送禮才夠有面子！🛍️",
    "xiSprite": "dim",
    "qianSprite": "active-talk"
  },
  {
    "id": "q8_pref_choice",
    "speaker": "決策時間",
    "text": "Q15 (抉擇): 你會選擇什麼樣的伴手禮？",
    "xiSprite": "idle",
    "qianSprite": "idle",
    "choices": [
      { "text": "🎁 充滿誠意與家鄉味的新鮮土產", "points": { "xihu": 10, "qianzhen": -5 }, "next": "q4_qian_quiz" },
      { "text": "🛍️ 精緻高質感的現代甜點精品", "points": { "xihu": -5, "qianzhen": 10 }, "next": "q4_qian_quiz" }
    ]
  },

  {
    ...
    "qianSprite": "active-talk",
    "choices": [
      { "text": "🏙️ 亞洲新灣區", "points": { "xihu": 0, "qianzhen": 5 }, "next": "q9_pref_xi" },
      { "text": "🏙️ 信義計畫區", "points": { "xihu": 0, "qianzhen": -10 }, "next": "q9_pref_xi" },
      { "text": "🏙️ 水湳經貿園區", "points": { "xihu": 0, "qianzhen": -10 }, "next": "q9_pref_xi" }
    ]
  },
...

  {
    "id": "q5_xi_quiz",
    "speaker": "溪湖醬 (小溪)",
    "text": "溪湖測驗最後一題！溪湖早期的發展歷史與哪一個產業的關係最密切？",
    "xiSprite": "active-talk",
    "qianSprite": "dim",
    "choices": [
      { "text": "💻 半導體產業", "points": { "xihu": -10, "qianzhen": 0 }, "next": "q10_pref_xi" },
      { "text": "⛏️ 採礦業", "points": { "xihu": -10, "qianzhen": 0 }, "next": "q10_pref_xi" },
...

  {
    ...
    "choices": [
      ...
      { "text": "🏟️ 室內體育場", "points": { "xihu": 0, "qianzhen": -10 }, "next": "result_tally" }
    ]
  },
